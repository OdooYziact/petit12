...
class Pricelist(models.Model):
    ...
    ### OVERWRITE ### adding code at line 144
    @api.multi
        ...
        for product, qty, partner in products_qty_partner:
            ...
            for rule in items:
                ...
                if price is not False:
                    ...
                    ### CHANGE HERE ###
                    elif rule.compute_price == 'coefficient':
                        price = (price * rule.coefficient_price) or 0.0
                    else:
                        # complete formula
                        price_limit = price
...
class PricelistItem(models.Model):
    ...
    coefficient_price = fields.Float('Coefficient')

    ### OVERWRITE ### adding code at line 206
    @api.one
    ...
    def _get_pricelist_item_name_price(self):
        ...
        ### CHANGE HERE ###
        elif self.compute_price == 'coefficient':
            self.price = _("x %s (coefficient)") % (self.coefficient_price)
        else:
